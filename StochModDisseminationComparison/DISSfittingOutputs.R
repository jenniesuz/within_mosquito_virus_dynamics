...
#*************escape rate**************
output <- readRDS(here("rdsOutputs//DissModelFitSepEscapeRateParms310722.rds"))

-2*(-output$value) + 2*2  # 1267
# estimates
MLEfits <- output[[1]]
prodRate1 <- 100
prodRate2 <- 100
cellSpread1 <- 10^-3.5
cellSpread2 <- 10^-3.5
escapeRate1 <- exp(MLEfits)[1]
escapeRate2 <- exp(MLEfits)[2]
...
#*************escape rate and production rate**************
output <- readRDS(here("rdsOutputs//DissModelFitSepEscapeRateProdRateParms010822.rds"))

-2*(-output$value) + 2*4 # 1247
# estimates
MLEfits <- output[[1]]
prodRate1 <- 100
prodRate2 <- 100
